...
- **Q: How large should the sub-tomograms for model fitting and tomogram refinement be?**\
  ...
  In most of our experiments, we used sub-tomograms of size 96x96x96 pixels, and we recommend not going below 64x64x64 pixels. \
